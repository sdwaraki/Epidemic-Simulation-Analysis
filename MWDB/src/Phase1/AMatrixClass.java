...
public class AMatrixClass {
	...
	AMatrixClass() throws BiffException, IOException
	{
	...
	public void calculateRowsInFile(String fileType, String epidemicFileName1, String epidemicFileName2){
		...
		try 
		{
			epidemicFile1 = new FileReader(filePath+epidemicFileName1+".csv");
			...
			br1.close();
			epidemicFile2 = new FileReader(filePath+epidemicFileName2+".csv");
	...
	public void performFileOperations(String fileType, String epidemicFileName1, String epidemicFileName2) throws IOException{
		
		calculateRowsInFile(fileType, epidemicFileName1,epidemicFileName2);
		...
		try 
		{
			...
			//displayMatrix();
			double finalSimilarity = getSimilarityFromAMatrix();
			System.out.println("The final similarity of A Matrix " + finalSimilarity);
